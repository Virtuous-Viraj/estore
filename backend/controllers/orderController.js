...
const createOrder = async (req, res, next) =>{
        try {
            ...
            {
                return res.status(400).send("All inputes are required")
            }
            ...
            // find products in the ids array
...
module.exports = {getUserOrders, getOrder, createOrder, updateOrderToPaid, updateOrderToBeDelivered, getOrders, getOrderForAnalysis}