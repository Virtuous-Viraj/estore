...
function UserProfilePageComponent({updateUserApiRequest , fetchUser, userInfoFromRedux, setReduxUserState, reduxDispatch, localStorage, sessionStorage }){
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control
                disabled
                value={
                    user.email + " if you want to change email, remove account and create new one with new email address"
                }
              />   
            </Form.Group>
