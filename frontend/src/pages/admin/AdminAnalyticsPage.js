  ...
  return (
    <Row className="m-5">
      ...
      <Col md={10}>
        ...
        <Form.Group className="firstDateToCompare">
        ...
        <br />
        <Form.Group className="secondDateToCompare">
          <Form.Label>Select second date to compare</Form.Label>
          <Form.Control type="date" name="secondDateToCompare" placeholder=" Date To Compare">
